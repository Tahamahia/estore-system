...
import { externalShipmentRoutes } from './routes/external_shipments';
import { internalShipmentRoutes } from './routes/internal_shipments';
...
protectedApp.route('/external-shipments', externalShipmentRoutes);
protectedApp.route('/internal-shipments', internalShipmentRoutes);
